...
import com.example.timerpart1.adapters.NotesAdapter;
import com.example.timerpart1.callbacks.MainActionModeCallback;
import com.example.timerpart1.callbacks.NoteEventListener;
import com.example.timerpart1.db.NotesDB;
import com.example.timerpart1.db.NotesDao;
import com.example.timerpart1.model.Note;
import com.example.timerpart1.EditNoteActivity1;
import com.example.timerpart1.utils.NoteUtils;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.ArrayList;
import java.util.List;

import static com.example.timerpart1.EditNoteActivity1.NOTE_EXTRA_Key;

public class NotesMainActivity1 extends AppCompatActivity implements NoteEventListener {
    ...
    private void onAddNewNote() {
        startActivity(new Intent(this, EditNoteActivity1.class));
    ...
    public void onNoteClick(Note note) {
        ...
        Intent edit = new Intent(this, EditNoteActivity1.class);
    ...
    private void swipeToDelete(final Note swipedNote, final RecyclerView.ViewHolder viewHolder) {
        new AlertDialog.Builder(NotesMainActivity1.this)
