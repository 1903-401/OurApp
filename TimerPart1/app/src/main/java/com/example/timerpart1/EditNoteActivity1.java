...
public class EditNoteActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set theme
        SharedPreferences sharedPreferences = getSharedPreferences(NotesMainActivity1.APP_PREFERENCES, Context.MODE_PRIVATE);
        int theme = sharedPreferences.getInt(NotesMainActivity1.THEME_Key, R.style.AppTheme);
        setTheme(theme);
