...
public class Version2GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_version2_game);
        ...
        imageBoxRight = getResources().getDrawable(R.drawable.box);
